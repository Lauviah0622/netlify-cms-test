  ...
  collection: {
    ...
    collectionTop: {
      ...
      searchResultsInCollection:
        '在 %{collection} 中搜尋 %{searchTerm}" 的結果',
      filterBy: '篩選方式',
    },
    entries: {
      loadingEntries: '載入內容',
...
const res = CMS.registerLocale('zh', zh);

console.log('zh', zh);

console.log('CMS', CMS);

console.log('getLocale', CMS.getLocale());
